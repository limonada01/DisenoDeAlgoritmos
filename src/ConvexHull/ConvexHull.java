...
public class ConvexHull {
    ...
    public static ArrayList convexHull(ArrayList<Punto> puntos) {
        ...
        findHull(S1, A, B, solucion);
        findHull(S2, B, A, solucion);
        return solucion;
    }

   

    public static void findHull(ArrayList<Punto> puntos, Punto A, Punto B, ArrayList<ParPuntos> solucion) {
        ...
        if (!puntos.isEmpty()) {
            ...
            findHull(S1, A, c, solucion);
            findHull(S2, c, B, solucion);
